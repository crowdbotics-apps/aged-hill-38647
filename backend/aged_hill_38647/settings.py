"""
Django settings for aged_hill_38647 project.
...
ROOT_URLCONF = 'aged_hill_38647.urls'
...
WSGI_APPLICATION = 'aged_hill_38647.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_hill_38647 API",
    "DESCRIPTION": "API documentation for aged_hill_38647 App",
    "VERSION": "v1",
}
